        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="w-[532px] bg-white rounded-[18px] shadow-md px-[30px] py-5">
                ...
                <div className="flex flex-col justify-center items-center mt-[10px] gap-[30px]">
                    <span className="text-[#170F49] font-extrabold text-[22px] leading-10 tracking-tighter">공유 대상 선택</span>
                    ...
                    <div className="flex flex-row items-center justify-center gap-5">
                        ...
                        <button onClick={onClickShare} className="w-[215px] h-[58px] px-10 py-[13px] bg-[#4A3AFF] text-white rounded-xl font-bold text-lg tracking-tighter">확인</button>
                    </div>
                </div>
            </div>
        </div>
