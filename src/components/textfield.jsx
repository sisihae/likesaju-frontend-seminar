...
export const TextField = ({ type, value, onChange, onBlur, placeholder, error, confirmText }) => {
  return (
    <div className="flex flex-col w-full">
      <div
        className="w-full h-[54px] px-[25px] py-3 bg-white rounded-xl border border-slate-200 justify-start items-center inline-flex">
        <input
          type={type}
          value={value}
          onChange={onChange}
